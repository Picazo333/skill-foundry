...
## Active VNext migration program
The operator-authorized VNext migration is governed by:
- `foundry/plans/VNEXT_MASTER_PLAN.md`
- `foundry/plans/VNEXT_EXECUTION_MANIFEST.yaml`
